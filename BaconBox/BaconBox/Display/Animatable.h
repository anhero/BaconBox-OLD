...
namespace BaconBox {
	...
	public:
		 ...
		 * is playing.
		 * @see BaconBox::Animatable::animationPaused
		 */
		 ...
		 * @see BaconBox::Animatable::defaultFrame
		 */
		 ...
		 * @see BaconBox::Animatable::animations
		 */
		 ...
		 * @param nbFrames Number of frames to load. If set to 0, it will use
		 * the maximum frame number for the texture and size of the Animatable
		 * object.
		 * @see BaconBox::Animatable::frames
		 */
