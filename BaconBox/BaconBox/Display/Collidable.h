...
namespace BaconBox {
	...
	public:
		 ...
		 * @see BaconBox::Collidable::oldPosition
		 */
		 ...
		 * vertical velocity.
		 * @see BaconBox::Collidable::velocity
		 */
		 ...
		 * velocity.
		 * @see BaconBox::Collidable::maximumVelocity
		 */
		 ...
		 * @see BaconBox::Collidable::setMaximumVelocity(const Vector2& newMaximumVelocity)
		 * @see BaconBox::Collidable::maximumVelocity
		 */
		 ...
		 * @see BaconBox::Collidable::acceleration
		 */
		 ...
		 * @see BaconBox::Collidable::setAcceleration(float newXAcceleration,
		 ...
		 * @see BaconBox::Collidable::setAcceleration(const Vector2&
		 * newAcceleration)
		 * @see BaconBox::Collidable::acceleration
		 */
		 ...
		 * @see BaconBox::Collidable::globalDrag
		 */
		 ...
		 * @see BaconBox::Collidable::collidableSides
		 */
		 ...
		 * @see BaconBox::Collidable::elasticity
		 */
		 ...
		 * @see BaconBox::Collidable::staticBody
		 */
		 ...
		 * @see BaconBox::Collidable::offset
		 */
		 ...
		 * box ratios.
		 * @see BaconBox::Collidable::collidingBoxRatio;
		 */
		 ...
		 * @see BaconBox::Collidable::offsetRatio
		 */
		 ...
		 * @see BaconBox::CollisionDetails
		 * @see BaconBox::Collidable(Collidable *other)
		 */
