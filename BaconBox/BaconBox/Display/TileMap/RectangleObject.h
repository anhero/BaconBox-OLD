...
namespace BaconBox {
	...
	public:
		/**
		 * Sets the name of the rectangle object. Does nothing if another
		 * rectangle object with the same name exists in the parent layer.
		 ...
		 * @see BaconBox::RectangleObject::size
		 */
