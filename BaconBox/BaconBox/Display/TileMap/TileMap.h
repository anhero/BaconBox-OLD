...
namespace BaconBox {
	...
	public:
		 ...
		 * @see BaconBox::TileMap::sizeInTiles
		 * @see BaconBox::TileMap::tileSize
		 */
		 ...
		 * @see BaconBox::TileMap::removeTileset(const Tileset *tileset)
		 */
		 ...
		 * specified name.
		 * @see BaconBox::TileMap::layersByName
		 */
