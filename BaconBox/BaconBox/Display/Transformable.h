...
namespace BaconBox {
	...
	public:
		 ...
		 * @see BaconBox::Transformable::addToScaling(const Vector2 &scalingToAdd)
		 * @see BaconBox::Transformable::scaling
		 */
		 ...
		 * @see BaconBox::Transformable::scaling
		 * @see BaconBox::Transformable::scaleFromPoint(float xScaling, float yScaling, const Vector2 &fromPoint)
		 */
