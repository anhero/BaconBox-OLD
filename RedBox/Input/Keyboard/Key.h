...
namespace RedBox {
	...
	namespace Key {
		...
		const Enum O = 105;
		const Enum OEM_8 = 106;
		const Enum OEM_AUTO = 107;
		const Enum OEM_BACKSLASH = 108;
		const Enum OEM_CLEAR = 109;
		const Enum OEM_CLOSE_BRACKETS = 110;
		const Enum OEM_COMMA = 111;
		const Enum OEM_COPY = 112;
		const Enum OEM_ENL_W = 113;
		const Enum OEM_MINUS = 114;
		const Enum OEM_OPEN_BRACKETS = 115;
		const Enum OEM_PERIOD = 116;
		const Enum OEM_PIPE = 117;
		const Enum OEM_PLUS = 118;
		const Enum OEM_QUESTION = 119;
		const Enum OEM_QUOTES = 120;
		const Enum OEM_SEMICOLON = 121;
		const Enum OEM_TILDE = 122;
		const Enum P = 123;
		const Enum PA_1 = 124;
