...
namespace RedBox {
	...
	public:
		...
		/**
		 * Return true if the current AABB overlaps the given  horizontal line. The line must be a flat 
		 ...
		 */
		bool horizLineOverlaps(float linePosition, float lowerXBoundary = 1.0f, float higherXBoundary = -1.0f);
		/**
		 * Return true if the current AABB overlaps the given vertical line. The line must be a flat 
		 ...
		 */
		bool vertLineOverlaps(float linePosition, float lowerYBoundary = 1.0f, float higherYBoundary = -1.0f);
		...
		/**
		 * Return true if the given AABB overlaps the given horizontal line. The line must be a flat 
		 * line parallel to the X axis (cutting the Y axis at position indicated by linePosition.
		 ...
		 * this value won't collide with the line). If the value is lower than lowerXBoundary, the line is infinite.
		 */
		static bool horizLineOverlaps(AABB & rect, float linePosition, float lowerXBoundary = 1.0f, float higherXBoundary = -1.0f);
		
		/**
		 * Return true if the given AABB overlaps the given vertical line. The line must be a flat 
		 * line parallel to the Y axis (cutting the X axis at position indicated by linePosition.
		 * @param rect The AABB you want to test.
		 * @param linePosition Position of the line on the X axis. (If the line have no boundaries, 
		 * it will cut the X axis at this position.
		 ...
		 * this value won't collide with the line). If the value is lower than lowerYBoundary, the line is infinite.
		 */
		static bool vertLineOverlaps(AABB & rect, float linePosition, float lowerYBoundary = 1.0f, float higherYBoundary = -1.0f);
