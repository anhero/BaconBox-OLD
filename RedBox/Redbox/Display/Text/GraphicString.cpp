...
GraphicString::GraphicString(Font* font, int x, int y, Alignment alignment,
                             StringDirection direction) : GraphicBody(),
	x(x), y(y), font(font), alignment(alignment), direction(direction) {
